...
export const Route = createFileRoute("/assignments")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Assignments — AssetFlow" },
      { property: "og:description", content: "Track active, pending, and returned asset assignments across the organization." },
    ],
  }),
  ...
  const filtered = useMemo(
    () =>
      assignments.filter((a) => {
        const matchQ =
          q.trim() === "" ||
          [a.assetTag, a.assetName, a.employee, a.department].some((v) =>
    ...
    >
      ...
      <div className="flex flex-col gap-3 rounded-lg border border-border bg-card p-4 shadow-sm sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="Search by employee, asset tag, or department..."
            value={q}
